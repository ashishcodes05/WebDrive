    ...
    return (
        <div className='flex bg-background h-screen w-full justify-center items-center'>
            <form
                ...
                className="w-full sm:w-[450px] text-center border border-zinc-300/60 dark:border-zinc-700 rounded-2xl px-8 bg-zinc-900 py-6 shadow-md"
            >
                <h1 className="flex justify-center items-center text-zinc-900 dark:text-white text-3xl mt-10 font-medium">
                    <Cloud className="inline-block mb-1 mr-2 text-indigo-500" size={40} />
                ...
                <p className="text-zinc-500 dark:text-zinc-400 text-sm mt-3 mb-11">
                    ...
                    <button type="button" className="text-indigo-500 dark:text-indigo-400 cursor-pointer hover:underline" onClick={() => setState((prev) => prev === "login" ? "register" : "login")} >
