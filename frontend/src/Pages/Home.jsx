  ...
  return (
    <section className="flex flex-col items-center text-white text-sm bg-background min-h-screen">
      ...
      <nav className="z-50 flex items-center justify-between h-24 w-full py-6 px-6 md:px-16 lg:px-24 xl:px-32 backdrop-blur">
        ...
        <div className="hidden md:block space-x-3 text-md">
      ...
      <div className="flex flex-col items-center justify-end z-40">
        ...
        <div className="flex items-center gap-4 mt-8">
          ...
          <button className="border border-secondary-400 font-bold text-secondary-accent hover:border-slate-400 hover:text-slate-300 active:scale-95 transition rounded-lg px-8 h-11">
            Get Premium Access
          </button>
        </div>
        <img
          src="https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/hero/hero-section-showcase-2.png"
          className="w-full rounded-[15px] max-w-2xl mt-16"
